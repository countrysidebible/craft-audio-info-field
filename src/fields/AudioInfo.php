...
class AudioInfo extends Field
{
    ...
    {
        return Craft::t('craft-audio-info-field', 'Audio Info');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'craft-audio-info-field/_components/fields/AudioInfo_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(AudioInfoFieldAsset::class);
        ...
        $jsonVars = [
            ...
            's3' => $this->getSettings()['mediaBaseUrl']
            ];
        $jsonVars = Json::encode($jsonVars);
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').CraftAudioInfoFieldAudioInfo(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'craft-audio-info-field/_components/fields/AudioInfo_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
